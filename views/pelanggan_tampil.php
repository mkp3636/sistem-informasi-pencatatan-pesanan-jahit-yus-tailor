                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?page=pelanggan&actions=edit&id=<?= $data['id_pl'] ?>" class="btn btn-warning btn-xs">
                                            <span class="fa fa-edit"></span>
                                        </a>
                                        <a href="?page=pelanggan&actions=delete&id=<?= $data['id_pl'] ?>" class="btn btn-danger btn-xs">
